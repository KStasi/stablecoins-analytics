...
# =============================================================================
# ZERO FEE ROUTES (chains where bridging is free)
# Format: list of (source_chain, dest_chain) tuples
# =============================================================================
# USDC zero-fee routes
...
# USDT Native Mesh zero-fee routes - 159 total routes
# Chains: Ethereum, OP Mainnet, Unichain, Sei Network, Polygon, Flare Mainnet,
#         Corn, Rootstock, Arbitrum One, Ink, Berachain, Plasma, HyperEVM, X Layer
USDT_NATIVE_ZERO_FEE_ROUTES = [
    # Ethereum routes (13 routes)
    ("Ethereum", "OP Mainnet"),
    ("Ethereum", "Unichain"),
    ("Ethereum", "Sei Network"),
    ("Ethereum", "Polygon"),
    ("Ethereum", "Flare Mainnet"),
    ("Ethereum", "X Layer"),
    ("Ethereum", "Corn"),
    ("Ethereum", "Rootstock"),
    ("Ethereum", "Arbitrum One"),
    ...
    ("Ethereum", "Plasma"),
    ("Ethereum", "HyperEVM"),
    # OP Mainnet routes (13 routes)
    ("OP Mainnet", "Ethereum"),
    ("OP Mainnet", "Unichain"),
    ("OP Mainnet", "Sei Network"),
    ("OP Mainnet", "Polygon"),
    ("OP Mainnet", "Flare Mainnet"),
    ("OP Mainnet", "X Layer"),
    ("OP Mainnet", "Corn"),
    ("OP Mainnet", "Rootstock"),
    ("OP Mainnet", "Arbitrum One"),
    ("OP Mainnet", "Ink"),
    ("OP Mainnet", "Berachain"),
    ("OP Mainnet", "HyperEVM"),
    # Unichain routes (13 routes)
    ("Unichain", "Ethereum"),
    ("Unichain", "OP Mainnet"),
    ("Unichain", "Sei Network"),
    ("Unichain", "Polygon"),
    ("Unichain", "Flare Mainnet"),
    ("Unichain", "X Layer"),
    ("Unichain", "Corn"),
    ("Unichain", "Rootstock"),
    ("Unichain", "Arbitrum One"),
    ("Unichain", "Ink"),
    ("Unichain", "Berachain"),
    ("Unichain", "HyperEVM"),
    # Sei Network routes (13 routes)
    ("Sei Network", "Ethereum"),
    ("Sei Network", "OP Mainnet"),
    ("Sei Network", "Unichain"),
    ("Sei Network", "Polygon"),
    ("Sei Network", "Flare Mainnet"),
    ("Sei Network", "X Layer"),
    ("Sei Network", "Corn"),
    ("Sei Network", "Rootstock"),
    ("Sei Network", "Arbitrum One"),
    ("Sei Network", "Ink"),
    ("Sei Network", "Berachain"),
    ("Sei Network", "HyperEVM"),
    # Polygon routes (13 routes)
    ("Polygon", "Ethereum"),
    ("Polygon", "OP Mainnet"),
    ("Polygon", "Unichain"),
    ("Polygon", "Sei Network"),
    ("Polygon", "Flare Mainnet"),
    ("Polygon", "X Layer"),
    ("Polygon", "Corn"),
    ("Polygon", "Rootstock"),
    ...
    ("Polygon", "Plasma"),
    ("Polygon", "HyperEVM"),
    # Flare Mainnet routes (13 routes)
    ("Flare Mainnet", "Ethereum"),
    ("Flare Mainnet", "OP Mainnet"),
    ("Flare Mainnet", "Unichain"),
    ("Flare Mainnet", "Sei Network"),
    ("Flare Mainnet", "Polygon"),
    ("Flare Mainnet", "X Layer"),
    ("Flare Mainnet", "Corn"),
    ("Flare Mainnet", "Rootstock"),
    ("Flare Mainnet", "Arbitrum One"),
    ("Flare Mainnet", "Ink"),
    ("Flare Mainnet", "Berachain"),
    ("Flare Mainnet", "HyperEVM"),
    # Corn routes (11 routes)
    ("Corn", "Ethereum"),
    ("Corn", "OP Mainnet"),
    ("Corn", "Unichain"),
    ("Corn", "Sei Network"),
    ...
    ("Corn", "Berachain"),
    ("Corn", "HyperEVM"),
    # Rootstock routes (11 routes)
    ("Rootstock", "Ethereum"),
    ("Rootstock", "OP Mainnet"),
    ("Rootstock", "Unichain"),
    ("Rootstock", "Sei Network"),
    ("Rootstock", "Polygon"),
    ("Rootstock", "Flare Mainnet"),
    ("Rootstock", "X Layer"),
    ("Rootstock", "Arbitrum One"),
    ("Rootstock", "Ink"),
    ("Rootstock", "Berachain"),
    ("Rootstock", "HyperEVM"),
    # Arbitrum One routes (13 routes)
    ("Arbitrum One", "Ethereum"),
    ("Arbitrum One", "OP Mainnet"),
    ("Arbitrum One", "Unichain"),
    ("Arbitrum One", "Sei Network"),
    ("Arbitrum One", "Polygon"),
    ("Arbitrum One", "Flare Mainnet"),
    ("Arbitrum One", "X Layer"),
    ("Arbitrum One", "Corn"),
    ("Arbitrum One", "Rootstock"),
    ("Arbitrum One", "Ink"),
    ("Arbitrum One", "Berachain"),
    ("Arbitrum One", "Plasma"),
    ("Arbitrum One", "HyperEVM"),
    # Ink routes (13 routes)
    ("Ink", "Ethereum"),
    ("Ink", "OP Mainnet"),
    ("Ink", "Unichain"),
    ("Ink", "Sei Network"),
    ...
    ("Ink", "Berachain"),
    ("Ink", "HyperEVM"),
    # Berachain routes (13 routes)
    ("Berachain", "Ethereum"),
    ("Berachain", "OP Mainnet"),
    ("Berachain", "Unichain"),
    ("Berachain", "Sei Network"),
    ("Berachain", "Polygon"),
    ("Berachain", "Flare Mainnet"),
    ("Berachain", "X Layer"),
    ("Berachain", "Corn"),
    ("Berachain", "Rootstock"),
    ("Berachain", "Arbitrum One"),
    ("Berachain", "Ink"),
    ("Berachain", "Plasma"),
    ("Berachain", "HyperEVM"),
    # Plasma routes (13 routes)
    ("Plasma", "Ethereum"),
    ("Plasma", "OP Mainnet"),
    ("Plasma", "Unichain"),
    ("Plasma", "Sei Network"),
    ("Plasma", "Polygon"),
    ("Plasma", "Flare Mainnet"),
    ("Plasma", "X Layer"),
    ("Plasma", "Corn"),
    ("Plasma", "Rootstock"),
    ("Plasma", "Arbitrum One"),
    ...
    ("Plasma", "Berachain"),
    ("Plasma", "HyperEVM"),
    # HyperEVM routes (13 routes)
    ("HyperEVM", "Ethereum"),
    ("HyperEVM", "OP Mainnet"),
    ("HyperEVM", "Unichain"),
    ("HyperEVM", "Sei Network"),
    ("HyperEVM", "Polygon"),
    ("HyperEVM", "Flare Mainnet"),
    ("HyperEVM", "X Layer"),
    ("HyperEVM", "Corn"),
    ("HyperEVM", "Rootstock"),
    ("HyperEVM", "Arbitrum One"),
    ("HyperEVM", "Ink"),
    ("HyperEVM", "Berachain"),
]

# USDT0 (bridged USDT) zero-fee routes - 207 total routes
# Chains: Ethereum, OP Mainnet, Lisk, Unichain, Sonic, Swellchain, Fraxtal,
#         Mode Mainnet, Celo, Mantle, Ink, Linea Mainnet, Base, Metis,
#         Soneium, Ronin, Superseed, BOB
USDT0_ZERO_FEE_ROUTES = [
    # Ethereum routes (3 routes)
    ("Ethereum", "OP Mainnet"),
    ("Ethereum", "Unichain"),
    ("Ethereum", "Ink"),
    # OP Mainnet routes (17 routes)
    ("OP Mainnet", "Ethereum"),
    ("OP Mainnet", "Unichain"),
    ("OP Mainnet", "Metis"),
    ("OP Mainnet", "Lisk"),
    ("OP Mainnet", "Sonic"),
    ("OP Mainnet", "Soneium"),
    ("OP Mainnet", "Swellchain"),
    ("OP Mainnet", "Ronin"),
    ("OP Mainnet", "Fraxtal"),
    ("OP Mainnet", "Mode Mainnet"),
    ("OP Mainnet", "Celo"),
    ("OP Mainnet", "Mantle"),
    ("OP Mainnet", "Superseed"),
    ("OP Mainnet", "Ink"),
    ("OP Mainnet", "Linea Mainnet"),
    ("OP Mainnet", "BOB"),
    ("OP Mainnet", "Base"),
    # Lisk routes (17 routes)
    ("Lisk", "Ethereum"),
    ("Lisk", "OP Mainnet"),
    ("Lisk", "Metis"),
    ("Lisk", "Unichain"),
    ...
    ("Unichain", "Ronin"),
    ("Unichain", "Fraxtal"),
    ("Unichain", "Mode Mainnet"),
    ("Unichain", "Celo"),
    ("Unichain", "Mantle"),
    ("Unichain", "Superseed"),
    ("Unichain", "Ink"),
    ("Unichain", "Linea Mainnet"),
    ("Unichain", "BOB"),
    ("Unichain", "Base"),
    # Sonic routes (17 routes)
    ("Sonic", "Ethereum"),
    ("Sonic", "OP Mainnet"),
    ("Sonic", "Metis"),
    ("Sonic", "Lisk"),
    ...
    ("Sonic", "BOB"),
    ("Sonic", "Base"),
    # Swellchain routes (17 routes)
    ("Swellchain", "Ethereum"),
    ("Swellchain", "OP Mainnet"),
    ("Swellchain", "Metis"),
    ("Swellchain", "Lisk"),
    ("Swellchain", "Unichain"),
    ("Swellchain", "Sonic"),
    ...
    ("Swellchain", "Ronin"),
    ("Swellchain", "Fraxtal"),
    ("Swellchain", "Mode Mainnet"),
    ("Swellchain", "Celo"),
    ("Swellchain", "Mantle"),
    ("Swellchain", "Superseed"),
    ("Swellchain", "Ink"),
    ("Swellchain", "Linea Mainnet"),
    ("Swellchain", "BOB"),
    ("Swellchain", "Base"),
    # Fraxtal routes (17 routes)
    ("Fraxtal", "Ethereum"),
    ("Fraxtal", "OP Mainnet"),
    ("Fraxtal", "Metis"),
    ("Fraxtal", "Lisk"),
    ...
    ("Fraxtal", "Swellchain"),
    ("Fraxtal", "Ronin"),
    ("Fraxtal", "Mode Mainnet"),
    ("Fraxtal", "Celo"),
    ("Fraxtal", "Mantle"),
    ("Fraxtal", "Superseed"),
    ("Fraxtal", "Ink"),
    ("Fraxtal", "Linea Mainnet"),
    ("Fraxtal", "BOB"),
    ("Fraxtal", "Base"),
    # Mode Mainnet routes (17 routes)
    ("Mode Mainnet", "Ethereum"),
    ("Mode Mainnet", "OP Mainnet"),
    ("Mode Mainnet", "Metis"),
    ("Mode Mainnet", "Lisk"),
    ("Mode Mainnet", "Unichain"),
    ("Mode Mainnet", "Sonic"),
    ("Mode Mainnet", "Soneium"),
    ("Mode Mainnet", "Swellchain"),
    ("Mode Mainnet", "Ronin"),
    ("Mode Mainnet", "Fraxtal"),
    ("Mode Mainnet", "Celo"),
    ("Mode Mainnet", "Mantle"),
    ("Mode Mainnet", "Superseed"),
    ("Mode Mainnet", "Ink"),
    ("Mode Mainnet", "Linea Mainnet"),
    ("Mode Mainnet", "BOB"),
    ("Mode Mainnet", "Base"),
    # Celo routes (17 routes)
    ("Celo", "Ethereum"),
    ("Celo", "OP Mainnet"),
    ("Celo", "Metis"),
    ("Celo", "Lisk"),
    ...
    ("Mantle", "Superseed"),
    ("Mantle", "Ink"),
    ("Mantle", "Linea Mainnet"),
    ("Mantle", "BOB"),
    ("Mantle", "Base"),
    # Ink routes (17 routes)
    ("Ink", "Ethereum"),
    ("Ink", "OP Mainnet"),
    ("Ink", "Metis"),
    ("Ink", "Lisk"),
    ...
    ("Ink", "BOB"),
    ("Ink", "Base"),
    # Linea Mainnet routes (17 routes)
    ("Linea Mainnet", "Ethereum"),
    ("Linea Mainnet", "OP Mainnet"),
    ("Linea Mainnet", "Metis"),
    ("Linea Mainnet", "Lisk"),
    ("Linea Mainnet", "Unichain"),
    ("Linea Mainnet", "Sonic"),
    ("Linea Mainnet", "Soneium"),
    ("Linea Mainnet", "Swellchain"),
    ("Linea Mainnet", "Ronin"),
    ("Linea Mainnet", "Fraxtal"),
    ("Linea Mainnet", "Mode Mainnet"),
    ("Linea Mainnet", "Celo"),
    ("Linea Mainnet", "Mantle"),
    ("Linea Mainnet", "Superseed"),
    ("Linea Mainnet", "Ink"),
    ("Linea Mainnet", "BOB"),
    ("Linea Mainnet", "Base"),
    # Base routes (17 routes)
    ("Base", "Ethereum"),
    ("Base", "OP Mainnet"),
    ("Base", "Metis"),
    ("Base", "Lisk"),
...
# Chain display order for zero-fee matrices
ZERO_FEE_CHAINS_USDC = ["Ethereum", "OP Mainnet", "Arbitrum One", "Ink", "Base"]

ZERO_FEE_CHAINS_USDT_NATIVE = [
    "Ethereum", "OP Mainnet", "Unichain", "Sei Network", "Polygon",
    "Flare Mainnet", "Corn", "Rootstock", "Arbitrum One", "Ink",
    "Berachain", "Plasma", "HyperEVM", "X Layer"
]

ZERO_FEE_CHAINS_USDT0 = [
    "Ethereum", "OP Mainnet", "Lisk", "Unichain", "Sonic", "Swellchain",
    "Fraxtal", "Mode Mainnet", "Celo", "Mantle", "Ink", "Linea Mainnet", "Base",
    "Metis", "Soneium", "Ronin", "Superseed", "BOB"
]

# Keep backward compatibility
ZERO_FEE_CHAINS = ZERO_FEE_CHAINS_USDC
USDT_ZERO_FEE_ROUTES = USDT_NATIVE_ZERO_FEE_ROUTES  # backward compat
